...
export const RegisterPage: React.FC<RegisterPageProps> = ({
  ...
  description = "Join us and start your journey with sustainable shopping",
  heroImageSrc,
  testimonials = [],
  onRegister,
  onGoogleSignUp,
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onRegister}>
              ...
              <div className="animate-element animate-delay-500">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Create a password" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" required minLength={8} />
              ...
              <div className="animate-element animate-delay-600">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} placeholder="Confirm your password" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" required minLength={8} />
